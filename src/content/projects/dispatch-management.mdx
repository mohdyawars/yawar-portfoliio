---
title: "Dispatch Goods – Internal Operations Platform"
description: "Internal operations platform for Dispatch Goods with automated QuickBooks invoice sync, SMS notifications, and scheduled data processing."
tech: ["Python", "Django", "Celery", "Redis", "PostgreSQL", "QuickBooks Online API", "Heymarket API"]
domain: logistics
constraint: "Reliability over features, idempotent processing, designed for non-technical operations staff"
featured: true
order: 2
---
